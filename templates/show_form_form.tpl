<section class="mini-layout">
    <div class="frame_title clearfix">
        <div class="pull-left">
            ...
            <span class="title">{lang("Widget settings", 'xforms')}<b> {$widget.name}</b></span>
        </div>
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small formSubmit btn-primary" data-form="#widget_form"><i
                            class="icon-ok"></i>{lang("Save", 'xforms')}</button>
                <button type="button" class="btn btn-small formSubmit btn-default" data-form="#widget_form"
                        data-action="tomain"><i class="icon-check"></i>{lang("Save and exit", 'xforms')}</button>
            </div>
        </div>
    </div>
