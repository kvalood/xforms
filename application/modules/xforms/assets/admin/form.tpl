<section class="mini-layout">
	<div class="frame_title clearfix">
		...
		<div class="pull-right">
			<div class="d-i_b">
                <a href="/admin/components/cp/xforms/" class="{if !$form.id}pjax{/if} t-d_n m-r_15"><span class="f-s_14">←</span> <span class="t-d_u">{lang("Back","admin")}</span></a>

                <button type="button" class="btn btn-small {if !$form.id}btn-success{else:}btn-primary{/if} action_on formSubmit" data-action="edit" data-form="#save" data-submit>
                    {if $form.id}<i class="icon-ok icon-white"></i>{lang("Save","admin")}{else:}<i class="icon-plus-sign icon-white"></i>{lang("Create","admin")}{/if}
                </button>
					...
					<td colspan="6">
						<div class="inside_padd">
							<div class="form-horizontal">
                                ...
                                <form id="save" method="post" action="{site_url('admin/components/cp/xforms/form')}{if $form.id}/{$form.id}{else:}{/if}">

									<div class="control-group">
										<label class="control-label" for="page_title">Название <span class="must">*</span></label>
										<div class="controls">
                                            <div class="o_h">
											    <input type="text" class="textbox_long" name="page_title" id="page_title_u" value="{$form.title}" required>
                                            </div>
									...
									<div class="control-group">
										...
										<div class="controls">
                                            <button onclick="translite_title('#page_title_u', '#page_url');" type="button" class="btn m-l_10" style="float:right;"><i class="icon-refresh"></i>&nbsp;&nbsp;Автозаполнение</button>
											<div class="o_h">
												<input type="text" name="page_url" value="{$form.url}" id="page_url" required>
											</div>
									...
									<div class="control-group">
										...
										<div class="controls">
                                            <div class="o_h">
											    <input type="text" class="textbox_long" name="email" id="email" value="{$form.email}" required/>
                                            </div>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="o_h">
                                                <input type="text" class="textbox_long" name="subject" id="subject" value="{$form.subject}" required/>
                                            </div>
                                        ...
                                        <div class="controls">
                                            <span class="frame_label no_connection m-t_5 m-b_10">
                                                <span class="niceCheck b_n">
                                                    <input type="checkbox" value="1" name="captcha"{if $form.captcha} checked{/if}>
                                                </span>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <span class="frame_label no_connection m-t_5 m-b_10">
                                                <span class="niceCheck b_n">
                                                    <input type="checkbox" value="1" name="direct_url"{if $form.direct_url} checked{/if}>
                                                </span>
